...
import { Mail, Phone, MapPin, Send, MessageSquare, Globe, ArrowRight, Instagram, Facebook } from "lucide-react"
        ...
        <>
            ...
            <main className="min-h-screen bg-slate-200">
                ...
                <section className="relative h-[40vh] min-h-[350px] flex items-end pb-16 overflow-hidden bg-[#020c1b]">
                    ...
                    <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-[#5865f2]/5 rounded-full blur-3xl opacity-60" />
                    ...
                    <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <motion.div
                            ...
                            className="max-w-3xl"
                        >
                            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#22C5C5] text-xs font-semibold tracking-wider uppercase mb-6 backdrop-blur-md">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#22C5C5] animate-pulse" />
                                Support Premium B2B
                            </span>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-sora tracking-tight leading-[1.1] mb-4">
                                Contact Direct
                            </h1>
                            <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
                                Une réponse immédiate pour vos besoins urgents.
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    >
                        ...
                        <a href="https://wa.me/21698621128" target="_blank" rel="noopener noreferrer" className="group bg-white p-8 rounded-3xl shadow-lg border-2 border-transparent hover:border-[#25D366] transition-all duration-300 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-[#042635] mb-2 font-sora">WhatsApp</h3>
                                <p className="text-slate-500 mb-6 font-medium">Réponse instantanée</p>
                                <span className="inline-flex items-center text-[#25D366] font-bold group-hover:translate-x-2 transition-transform">
                                    Chatter maintenant <ArrowRight className="w-4 h-4 ml-2" />
                                </span>
                            </div>
                        </a>
                        ...
                        <a href="tel:+21698621128" className="group bg-white p-8 rounded-3xl shadow-lg border-2 border-transparent hover:border-[#042635] transition-all duration-300 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-[#042635] mb-2 font-sora">Appel Direct</h3>
                                <p className="text-slate-500 mb-6 font-medium">Lun-Sam: 8h - 18h</p>
                        ...
                        <a href="mailto:sales@tafc.tn" className="group bg-white p-8 rounded-3xl shadow-lg border-2 border-transparent hover:border-[#22C5C5] transition-all duration-300 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-[#042635] mb-2 font-sora">Email</h3>
                                <p className="text-slate-500 mb-6 font-medium">Pour devis formel</p>
                        ...
                        >
                            ...
                            <div className="bg-[#042635] p-8 rounded-3xl shadow-lg relative overflow-hidden">
                                ...
                                <div className="relative z-10 text-center">
                                    ...
                                    <h3 className="text-white font-bold text-xl mb-1">Siège Social</h3>
                                    <p className="text-[#22C5C5] text-sm font-medium mb-4">Tunisie</p>
                                    <p className="text-slate-400 text-sm leading-relaxed">
                                        Plateforme d'exportation<br />Méditerranée Centrale
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <a href="https://www.instagram.com/tafc.seafood/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center p-6 bg-white rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition-all group">
                                    ...
                                    <span className="text-sm font-semibold text-slate-600">Instagram</span>
                                </a>
                        ...
                        >
                            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-sm border border-slate-100">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#042635]">Ou envoyez un message</h3>
                                        <p className="text-slate-400 text-sm">Nous traiterons votre email sous 24h</p>
                                    </div>
                                </div>
                                ...
                                <form className="space-y-5">
                                    <div className="grid md:grid-cols-2 gap-5">
                                        <div className="space-y-1.5">
                                            <Label htmlFor="name" className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Nom</Label>
                                            <Input id="name" className="h-11 bg-slate-50 border-slate-200 focus:border-[#042635] focus:ring-0 rounded-xl" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label htmlFor="company" className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Société</Label>
                                            <Input id="company" className="h-11 bg-slate-50 border-slate-200 focus:border-[#042635] focus:ring-0 rounded-xl" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-5">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input id="email" type="email" className="h-11 bg-slate-50 border-slate-200 focus:border-[#042635] focus:ring-0 rounded-xl" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label htmlFor="phone" className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Téléphone</Label>
                                            <Input id="phone" type="tel" className="h-11 bg-slate-50 border-slate-200 focus:border-[#042635] focus:ring-0 rounded-xl" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-2 flex justify-end">
                                        <Button className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-white px-8 py-5 text-base rounded-xl transition-all">
                                            Envoyer le message
                                        </Button>
                                    </div>
                                </form>
